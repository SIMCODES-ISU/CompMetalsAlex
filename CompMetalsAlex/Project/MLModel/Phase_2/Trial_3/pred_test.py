...
if __name__ == "__main__":
    ...
    NN_damp("/mnt/c/c++_tests/games_work/ml_work/clean_data/All_data/", "/mnt/c/c++_tests/games_work/ml_work/MLModel/Phase_2/Trial_3/NN_per_system3.csv")

    # df = pd.read_csv("/mnt/c/c++_tests/games_work/ml_work/MLModel/Phase_2/Trial_3/SAPT_Undp_NNcorrections3.csv")
    # df["Total Coulomb"] = df["Undamped Coulomb"] + df["DampNN"]
    # df.to_csv("/mnt/c/c++_tests/games_work/ml_work/MLModel/Phase_2/Trial_3/SAPT_Undp_NNcorrections3.csv", index=False)
