...
if __name__ == "__main__":
    ...
    for name, param in model.named_parameters():
        if "model.4" not in name:  # Freeze first 2 layers
    ...
    for epoch in range(num_epochs):
        ...
        for x_pairs, E_undamped, E_sapt, system_id in train_loader:
            ...
            # Compute loss
            loss = loss_fn(total_correction, residual.squeeze())
    ...
    loss_df.to_csv("phase2_loss_log_200E_1E-4LR_MSE_Clipped1_Fr2Layer_10.csv", index=False)
