...
def print_predictions(destination):
    ...
    model.load_state_dict(torch.load("phase1_damping_net.pth"))
    model.eval()
...
if __name__ == "__main__":
    print_predictions("/mnt/c/c++_tests/games_work/ml_work/MLModel/Phase_1/Trial_5/pair_predictions_file5.csv")
    #NN_damp("/mnt/c/c++_tests/games_work/ml_work/clean_data/All_data/", "/mnt/c/c++_tests/games_work/ml_work/MLModel/Phase_1/Trial_5/NN_per_system.csv")
    # df = pd.read_csv("/mnt/c/c++_tests/games_work/ml_work/MLModel/Phase_1/Trial_5/SAPT_Undp_NNcorrections5.csv")
    # df["Total Coulomb"] = df["Undamped Coulomb"] + df["DampNN"]
    # df.to_csv("/mnt/c/c++_tests/games_work/ml_work/MLModel/Phase_1/Trial_5/SAPT_Undp_NNcorrections5.csv", index=False)
