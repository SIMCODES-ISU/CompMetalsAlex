...
if __name__ == "__main__":
    ...
    #NN_damp("/mnt/c/c++_tests/games_work/ml_work/clean_data/All_data/", "/mnt/c/c++_tests/games_work/ml_work/MLModel/Phase_1/Trial_2/NN_per_system2.csv")
    df = pd.read_csv("/mnt/c/c++_tests/games_work/ml_work/MLModel/Phase_1/Trial_2/SAPT_Undp_NNcorrections2.csv")
    df["Total Coulomb"] = df["Undamped Coulomb"] + df["DampNN"]
    df.to_csv("/mnt/c/c++_tests/games_work/ml_work/MLModel/Phase_1/Trial_2/SAPT_Undp_NNcorrections2.csv", index=False)
